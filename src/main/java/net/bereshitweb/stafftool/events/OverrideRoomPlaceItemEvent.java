...
public class OverrideRoomPlaceItemEvent extends MessageHandler {
    @Override
    public void handle() throws Exception {
        ...
        //I must do this way because of lack of an event for furniture placing
        if(this.client.getHabbo().getHabboStats().cache.containsKey(StaffToolUtils.CHECKINVKEY))  {
            this.client.getHabbo().whisper(Emulator.getTexts().getValue("checkinventory.error.placeitem_disabled"));
            return;
        }
